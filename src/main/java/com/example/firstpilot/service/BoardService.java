...
public class BoardService {
    ...
    public String saveBoardFileInDir(MultipartFile uploadFile) throws Exception {
        ...
        // 이미지 파일은 썸네일 이미지 생성
        if(uploadFile.getContentType().substring(0, 5) == "image") {
    ...
    public static String makeThumbnail(String uploadRootPath, String fileName, String oriFileName) throws Exception {
    ...
    public static String replaceSavedFilePath(String fileName) {
